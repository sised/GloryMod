...
namespace Glorymod.Items.Weapons.Summon
{
    public class NightmareStaff : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Nightmare Staff");
            Tooltip.SetDefault("Conjures a Nightmare Spawn to protect you\nOnly one can exist at a time");
